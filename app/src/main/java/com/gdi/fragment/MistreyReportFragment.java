...
public class MistreyReportFragment extends Fragment implements View.OnClickListener {
    ...
    public static final String TAG = MistreyReportFragment.class.getSimpleName();
