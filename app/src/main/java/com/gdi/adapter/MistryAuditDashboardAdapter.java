...
public class MistryAuditDashboardAdapter extends RecyclerView.Adapter<MistryAuditDashboardAdapter.InternalAuditDashboardViewHolder> {

    private Context context;
    private ArrayList<IAMainDashboardInfo> orderData;

    public MistryAuditDashboardAdapter(Context context, ArrayList<IAMainDashboardInfo> orderData) {
