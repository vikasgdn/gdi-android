...
public class AddDSAttachmentRequest extends BaseStringRequest {
    ...
    public AddDSAttachmentRequest(String accessToken,String firebaseToken, String url, String fileName, byte[] byteData,
