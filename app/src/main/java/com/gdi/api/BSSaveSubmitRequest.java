...
public class BSSaveSubmitRequest extends BaseStringRequest {
    ...
    public BSSaveSubmitRequest(String accessToken,String firebaseToken, String url, String auditId,
