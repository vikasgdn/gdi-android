...
public class ReportBackHouseActivity extends BaseActivity implements
        DownloadPdfTask.PDFDownloadFinishedListner,
        DownloadExcelTask.DownloadExcelFinishedListner {

    @BindView(R.id.recycler_view_back_house)
    RecyclerView list1;
    ...
    private static final String TAG = ReportBackHouseActivity.class.getSimpleName();

    @Override
    protected void onResume() {
        super.onResume();
        AppUtils.hideKeyboard(ReportBackHouseActivity.this);
    }

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_report_back_house);
        context = this;
        ButterKnife.bind(ReportBackHouseActivity.this);
        initView();
    }
    ...
    private void initView() {
        ...
        list1 = findViewById(R.id.recycler_view_back_house);
    ...
    private void setData(){
        ...
        backHouseUrl = NetworkURL.BACKHOUSE + "?"
                + "brand_id=" + brandId + "&"
...
*/
    ...
    private void setActionBar() {
        initToolbar(toolbar);
        setTitle("Back of the House Audit");
        enableBack(true);
        enableBackPressed();
    }
...
*/
    ...
    public void downloadPdf(final String url) {
        if (ContextCompat.checkSelfPermission(context, Manifest.permission.WRITE_EXTERNAL_STORAGE)
            ...
            ActivityCompat.requestPermissions(ReportBackHouseActivity.this,
                    new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, REQUEST_FOR_WRITE_PDF);
        } else {
            DownloadPdfTask downloadTask = new DownloadPdfTask(context, url, ReportBackHouseActivity.this);
        }
    }
    ...
    public void downloadExcel(final String url) {
        if (ContextCompat.checkSelfPermission(context, Manifest.permission.WRITE_EXTERNAL_STORAGE)
            ...
            DownloadExcelTask downloadTask = new DownloadExcelTask(context, url, ReportBackHouseActivity.this);
        }
    }
