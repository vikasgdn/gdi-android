...
public class DetailSummaryActivity extends BaseActivity implements DownloadPdfTask.PDFDownloadFinishedListner, DownloadExcelTask.DownloadExcelFinishedListner {
    ...
    private static final String TAG = DetailSummaryActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = this;
        ButterKnife.bind(DetailSummaryActivity.this);
        initView();
    }
    ...
    public void downloadPdf(final String url) {
        if (ContextCompat.checkSelfPermission(context, Manifest.permission.WRITE_EXTERNAL_STORAGE)
            ...
            ActivityCompat.requestPermissions(DetailSummaryActivity.this,
                    new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, REQUEST_FOR_WRITE_PDF);

        } else {

            DownloadPdfTask downloadTask = new DownloadPdfTask(context, url, DetailSummaryActivity.this);
        }
    }
    ...
    public void downloadExcel(final String url) {
        if (ContextCompat.checkSelfPermission(context, Manifest.permission.WRITE_EXTERNAL_STORAGE)
            ...
            DownloadExcelTask downloadTask = new DownloadExcelTask(context, url, DetailSummaryActivity.this);
        }
    }
