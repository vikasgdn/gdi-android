...
public class SubSectionsActivityMistery extends BaseActivity implements SubSectionTabAdapter.CustomItemClickListener {
    ...
    private static final String TAG = SubSectionsActivityMistery.class.getSimpleName();
    ...
    private void setBrandStandardQuestion(){
        ...
        Response.Listener<String> stringListener = new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
               // AppLogger.e(TAG, "BrandStandardResponse: Mystery  " + response);
                try {
    ...
    private void setQuestionList(BrandStandardInfo info){
        ...
        SubSectionTabAdapter subSectionTabAdapter = new SubSectionTabAdapter(context, brandStandardSections, editable, SubSectionsActivityMistery.this);
    ...
    public void onItemClick(ArrayList<BrandStandardSection> brandStandardSections, int fileCount, int pos) {
        ...
        try {
           // Toast.makeText(this, "Mystery Audit", Toast.LENGTH_SHORT).show();
            Intent startAudit = new Intent(context, BrandStandardMisteryAuditActivity.class);
            ((GDIApplication)getApplicationContext()).setmBrandStandardSectionList(brandStandardSections);
        ...
        {
            Log.e("INTENT ERROR "," ===> ERRRRROOOORRRR");
            e.printStackTrace();
        }
    }
            ...
            for (int j = 0; j < brandStandardQuestion.size(); j++) {
                ...
                if (brandStandardQuestion.get(j).getQuestion_type().equals("textarea")||
                    ...
                    if (AppUtils.isStringEmpty(brandStandardQuestion.get(j).getAudit_answer())
                        ...
                        AppUtils.toast(SubSectionsActivityMistery.this, "You have not answered " +
