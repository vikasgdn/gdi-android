...
import com.gdi.activity.internalaudit.model.audit.BrandStandard.BrandStandardUnit;
import java.util.ArrayList;
import java.util.List;

public class BrandStandardQuestionForAction {
    ...
    private String can_create_action_plan;
