...
public class ReportExecutiveSummaryActivity extends BaseActivity implements DownloadPdfTask.PDFDownloadFinishedListner, DownloadExcelTask.DownloadExcelFinishedListner {
    ...
    Context context;
    private static final String TAG = ReportExecutiveSummaryActivity.class.getSimpleName();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_report_executive_summary);
        context = this;
        ButterKnife.bind(ReportExecutiveSummaryActivity.this);
        initView();
    }
    ...
    public void downloadPdf(final String url) {
        if (ContextCompat.checkSelfPermission(context, Manifest.permission.WRITE_EXTERNAL_STORAGE)
            ...
            ActivityCompat.requestPermissions(ReportExecutiveSummaryActivity.this,
                    new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, REQUEST_FOR_WRITE_PDF);

        } else {

            DownloadPdfTask downloadTask = new DownloadPdfTask(context, url, ReportExecutiveSummaryActivity.this);
        }
    }
    ...
    public void downloadExcel(final String url) {
        if (ContextCompat.checkSelfPermission(context, Manifest.permission.WRITE_EXTERNAL_STORAGE)
            ...
            DownloadExcelTask downloadTask = new DownloadExcelTask(context, url, ReportExecutiveSummaryActivity.this);
        }
    }
