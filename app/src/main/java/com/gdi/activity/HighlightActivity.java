...
public class HighlightActivity extends BaseActivity implements DownloadPdfTask.PDFDownloadFinishedListner, DownloadExcelTask.DownloadExcelFinishedListner {
    ...
    private ArrayList<com.gdi.model.highlights.LocationsInfo> locationsInfoArrayList;
    Context context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = this;
        ButterKnife.bind(HighlightActivity.this);
        initView();
    }
    ...
    private void setAuditDeparmentOffline() {
        ...
        //highlightAdapter1 = new HighlightAdapter1(context, sampleModels);
        list1.setLayoutManager(new LinearLayoutManager(context));
        list1.setAdapter(highlightAdapter1);
    }
    ...
    public void downloadPdf(final String url) {
        if (ContextCompat.checkSelfPermission(context, Manifest.permission.WRITE_EXTERNAL_STORAGE)
            ...
            ActivityCompat.requestPermissions(HighlightActivity.this,
                    new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, REQUEST_FOR_WRITE_PDF);

        } else {

            DownloadPdfTask downloadTask = new DownloadPdfTask(context, url, HighlightActivity.this);
        }
    }
    ...
    public void downloadExcel(final String url) {
        if (ContextCompat.checkSelfPermission(context, Manifest.permission.WRITE_EXTERNAL_STORAGE)
            ...
            DownloadExcelTask downloadTask = new DownloadExcelTask(context, url, HighlightActivity.this);
        }
    }
