...
public class InternalAuditDashboardActivity extends BaseActivity {
    ...
    private static final String TAG = InternalAuditDashboardActivity.class.getSimpleName();
    private ArrayList<IAMainDashboardInfo> iaMainDashboardInfos;

    @Override
    protected void onResume() {
        super.onResume();
        AppUtils.hideKeyboard(InternalAuditDashboardActivity.this);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ButterKnife.bind(InternalAuditDashboardActivity.this);
        context = this;
        initView();
    }
