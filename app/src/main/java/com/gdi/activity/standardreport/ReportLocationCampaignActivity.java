...
public class ReportLocationCampaignActivity extends BaseActivity implements View.OnClickListener,
    ...
    public void locationCampaignList() {
        ...
        String locationCampaignUrl = NetworkURL.LOCATIONCAMPAIGNSCORE + "?"
                + "brand_id=" + brandId ;
                    ...
                    .addOnCompleteListener(new OnCompleteListener<GetTokenResult>() {
                        public void onComplete(@NonNull Task<GetTokenResult> task) {
                            if (task.isSuccessful()) {
                                GetReportRequest getReportRequest = new GetReportRequest(AppPrefs.getAccessToken(context),task.getResult().getToken(), locationCampaignUrl, stringListener, errorListener);
