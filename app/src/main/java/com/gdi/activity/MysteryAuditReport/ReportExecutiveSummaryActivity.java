...
import com.gdi.model.reportexecutivesummary.ExecutiveSummaryRootObject;
...
public class ReportExecutiveSummaryActivity extends BaseActivity implements DownloadPdfTask.PDFDownloadFinishedListner, DownloadExcelTask.DownloadExcelFinishedListner {
    ...
    public void executiveSummaryList(){
        ...
        String executiveUrl = ApiEndPoints.EXECUTIVESUMMARY + "?"
                + "brand_id=" + brandId + "&"
                    ...
                    .addOnCompleteListener(new OnCompleteListener<GetTokenResult>() {
                        public void onComplete(@NonNull Task<GetTokenResult> task) {
                            if (task.isSuccessful()) {
                                GetReportRequest getReportRequest = new GetReportRequest(AppPrefs.getAccessToken(context),task.getResult().getToken(), executiveUrl, stringListener, errorListener);
