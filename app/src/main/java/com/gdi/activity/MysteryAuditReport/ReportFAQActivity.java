...
import com.gdi.adapter.FAQAdapter;
...
import com.gdi.model.reportfaq.FAQRootObject;
...
public class ReportFAQActivity extends BaseActivity implements
    ...
    private static final String TAG = ReportFAQActivity.class.getSimpleName();

    @Override
    protected void onResume() {
        super.onResume();
        AppUtils.hideKeyboard(ReportFAQActivity.this);
    }

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_report_faq);
        inflater = getLayoutInflater();
        context = this;
        ButterKnife.bind(ReportFAQActivity.this);
        initView();
    }
    ...
    private void initView() {
        ...
        recyclerViewFaq = (RecyclerView) findViewById(R.id.recycler_view_faq);
        ...
        search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                faqInfos = new ArrayList<>();
                setData();
                faqAdapter = new FAQAdapter(context, faqInfos);
                recyclerViewFaq.setLayoutManager(new LinearLayoutManager(context));
    ...
    private void setData(){
        ...
        Response.Listener<String> stringListener = new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                AppLogger.e(TAG, "FAQResponse: " + response);
                try {
                    JSONObject object = new JSONObject(response);

                    if (!object.getBoolean(ApiResponseKeys.RES_KEY_ERROR)) {
                        FAQRootObject faqRootObject = new GsonBuilder().create()
                                .fromJson(object.toString(), FAQRootObject.class);
                        if (faqRootObject.getData() != null &&
                                faqRootObject.getData().toString().length() > 0) {
                            faqInfos.addAll(faqRootObject.getData());
        ...
        Response.ErrorListener errorListener = new Response.ErrorListener() {
            ...
            public void onErrorResponse(VolleyError error) {
                hideProgressDialog();
                AppLogger.e(TAG, "FAQError: " + error.getMessage());
        ...
        String backHouseUrl = ApiEndPoints.FAQ + "?"
                + "brand_id=" + brandId + "&"
    ...
    private void setActionBar() {
        initToolbar(toolbar);
        setTitle(AppPrefs.getFaqTitle(context));
        enableBack(true);
        enableBackPressed();
    }
    ...
    public void downloadPdf(final String url) {
        if (ContextCompat.checkSelfPermission(context, Manifest.permission.WRITE_EXTERNAL_STORAGE)
            ...
            ActivityCompat.requestPermissions(ReportFAQActivity.this,
                    new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, REQUEST_FOR_WRITE_PDF);
        } else {
            DownloadPdfTask downloadTask = new DownloadPdfTask(context, url, ReportFAQActivity.this);
        }
    }
    ...
    public void downloadExcel(final String url) {
        if (ContextCompat.checkSelfPermission(context, Manifest.permission.WRITE_EXTERNAL_STORAGE)
            ...
            DownloadExcelTask downloadTask = new DownloadExcelTask(context, url, ReportFAQActivity.this);
        }
    }
