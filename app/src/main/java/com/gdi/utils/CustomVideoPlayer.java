...
public class CustomVideoPlayer extends LinearLayout {
    ...
    private void init(Context context) {
        ...
        exoPlayer = ExoPlayerFactory.newSimpleInstance(new DefaultRenderersFactory(context), new DefaultTrackSelector(trackSelectionFactory));
    ...
    private void initializeVideoPlayerView() {
        try {
            ...
            progressBar.getIndeterminateDrawable().setColorFilter(context.getResources().getColor(R.color.colorWhite), PorterDuff.Mode.MULTIPLY);
    ...
    private MediaSource buildMediaStore(String mediaUrl) {
        ...
        defaultHttpDataSourceFactory.getDefaultRequestProperties().set("access-token", AppPrefs.getAccessToken(context));
        DefaultExtractorsFactory extractorFactory = new DefaultExtractorsFactory();
        return new ExtractorMediaSource(videoUri, defaultHttpDataSourceFactory, extractorFactory, null, null);
    }
