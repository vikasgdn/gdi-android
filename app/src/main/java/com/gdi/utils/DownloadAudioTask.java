...
public class DownloadAudioTask {
    ...
    private AudioDownloadFinishedListner audioDownloadFinishedListner;


    public DownloadAudioTask(Context context, String downloadUrl, AudioDownloadFinishedListner audioDownloadFinishedListner) {
    ...
    private class DownloadingTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            try {
                if (outputFile != null) {
                    ...
                    audioDownloadFinishedListner.onAudioDownloadFinished(outputFile.getAbsolutePath());
        ...
        protected Void doInBackground(Void... voids) {
            try {
                ...
                outputFile = new File(apkStorage, System.currentTimeMillis()+".mp3");//Create Output file in Main File
    ...
    public interface AudioDownloadFinishedListner {
        void onAudioDownloadFinished(String file);
    }
}
